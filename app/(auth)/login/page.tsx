      ...
      <div className=" flex justify-center items-center">
        <div className=" space-y-5 flex justify-center  flex-col p-[30px] bg-[#FCFCFC] border border-[#E4E3EC] border-dashed rounded-[20px] h-[469px] w-[543px] ">
          ...
          <form className="flex flex-col gap-4 mt-4 ">
            ...
            <button className="bg-gradient-to-br from-[#439EFF] to-[#5B1E9F] text-white py-2 rounded-md text-[16px] font-medium hover:opacity-90 transition-opacity mt-2 cursor-pointer">
              Continue
            </button>
            <hr className=" border-t border-t-[#CBCBCB]/70" />
            <p className="text-center text-[#8C94A6] text-[13.78px] font-medium">
              Don&apos;t have an account?{" "}
              <span className="text-[#5B1E9F] cursor-pointer">Sign Up</span>
            </p>
          </form>
        </div>
      </div>
